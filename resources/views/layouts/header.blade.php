    ...
    <div class="container-fluid">
        <ul class="list-unstyled topnav-menu float-end mb-0">
            ...
            <li class="dropdown notification-list topbar-dropdown">
                <a class="nav-link dropdown-toggle nav-user me-0 waves-effect waves-light" data-bs-toggle="dropdown"
                    href="#" role="button" aria-haspopup="false" aria-expanded="false">
                    <img src="{{ Auth::user()->photo ? asset(Auth::user()->photo) : asset('backend/assets/images/users/default.png') }}"
        ...
        <div class="logo-box">
            ...
            <a href="{{ url('/dashboard') }}" class="logo logo-light text-center">
                ...
                <span class="logo-lg">
                    <img src="{{ asset('backend/assets/images/rsalandan.png') }}" alt="" height="65">
                </span>
            </a>
        </div>
